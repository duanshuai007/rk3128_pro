...
#define CUST_COMBO_STP_DEV "/dev/ttyAMA2" //-- for ALPS
...
invalid_chip:
    ...
    printf("WMT_IOCTL_SET_STP_MODE:baud=%x,fmmode=%d,stpmode=%d\r\n",sStpParaConfig.sUartConfig.fc, gFmMode, gStpMode);
