...
extern void vcc_lcd_enable(int enable );
...
void lcd_ctrl_init(void *lcdbase)
{
	...
	printf("rk fb parse dt start.\n");
	int ret = rk_fb_parse_dt(fb, gd->fdt_blob);
	debug("rk fb parse dt end.\n");
	printf("rk fb parse dt end.\n");
	if (ret < 0)
    {
        printf("--->and then return\r\n");
		return;
    }
#endif

//#if defined(CONFIG_RK_HDMI)
//    printf("--->go rk_hdmi_probe\r\n");
...
//	if (g_hdmi_noexit == 1)
//#endif
//        printf("--->go rk1000_tve_init_panel\r\n");
...
//	if (g_hdmi_noexit == 1)
//#endif
//        printf("--->go gm7122_tve_init_panel\r\n");
