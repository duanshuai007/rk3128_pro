...
{0x0085,0x00}, //	; YCbYCr Order
{0x00B2,0x50}, //        ; set PLL output 713MHz
{0x00B3,0x80}, //
{0x00B4,0x01}, //        ; E_div
{0x00B5,0x02}, //        ; PLL3_div 2
{0x00E8,0x01}, //
...
{0x004C,0x0C}, //	; PipeSetupBank0 fPeakingGain
...
{0x0357,0x29}, //	; PeakingControl fUserPeakLoThresh 
{0x0358,0x00}, //	; PeakingControl fDisableCoringDamping  {CompiledExposureTime}
{0x0359,0x9C}, //	; PeakingControl fUserPeakHiThresh 
...
{0x0049,0x15}, //	; PipeSetupBank0 bGammaGain 
{0x004A,0x0F}, //	; PipeSetupBank0 bGammaInterpolationGain
{0x0069,0x15}, //	; PipeSetupBank1 bGammaGain 
{0x006A,0x0F}, //	; PipeSetupBank1 bGammaInterpolationGain
...
{0x0420,0xFF},    // C0_GreenRed_X
{0x0421,0xBB},    // C0_GreenRed_X LSB
{0x0422,0xFE},    // C0_GreenRed_Y
{0x0423,0x94},    // C0_GreenRed_Y LSB
{0x0424,0x00},    // C0_GreenRed_X2
{0x0425,0x86},    // C0_GreenRed_X2 LSB
{0x0426,0x00},    // C0_GreenRed_Y2
{0x0427,0x9F},    // C0_GreenRed_Y2 LSB
{0x0428,0x00},    // C0_GreenRed_XY
{0x0429,0x00},    // C0_GreenRed_XY LSB
{0x042A,0x01},    // C0_GreenRed_X2Y
{0x042B,0x2A},    // C0_GreenRed_X2Y LSB
{0x042C,0x00},    // C0_GreenRed_XY2
{0x042D,0xAD},    // C0_GreenRed_XY2 LSB
{0x042E,0xFF},    // C0_GreenRed_X2Y2
{0x042F,0x37},    // C0_GreenRed_X2Y2 LSB

{0x0430,0xFF},    // C0_Red_X
{0x0431,0xB1},    // C0_Red_X LSB
{0x0432,0xFE},    // C0_Red_Y
{0x0433,0x12},    // C0_Red_Y LSB
{0x0434,0x00},    // C0_Red_X2
{0x0435,0xC2},    // C0_Red_X2 LSB
{0x0436,0x00},    // C0_Red_Y2
{0x0437,0xE0},    // C0_Red_Y2 LSB
{0x0438,0x00},    // C0_Red_XY
{0x0439,0x00},    // C0_Red_XY LSB
{0x043A,0x01},    // C0_Red_X2Y
{0x043B,0x1E},    // C0_Red_X2Y LSB
{0x043C,0xFF},    // C0_Red_XY2
{0x043D,0x66},    // C0_Red_XY2 LSB
{0x043E,0xFE},    // C0_Red_X2Y2
{0x043F,0xF4},    // C0_Red_X2Y2 LSB

{0x0440,0xFF},    // C0_GreenBlue_X
{0x0441,0xBD},    // C0_GreenBlue_X LSB
{0x0442,0xFE},    // C0_GreenBlue_Y
{0x0443,0x96},    // C0_GreenBlue_Y LSB
{0x0444,0x00},    // C0_GreenBlue_X2
{0x0445,0x86},    // C0_GreenBlue_X2 LSB
{0x0446,0x00},    // C0_GreenBlue_Y2
{0x0447,0x9F},    // C0_GreenBlue_Y2 LSB
{0x0448,0x00},    // C0_GreenBlue_XY
{0x0449,0x00},    // C0_GreenBlue_XY LSB
{0x044A,0x01},    // C0_GreenBlue_X2Y
{0x044B,0x27},    // C0_GreenBlue_X2Y LSB
{0x044C,0x00},    // C0_GreenBlue_XY2
{0x044D,0xA7},    // C0_GreenBlue_XY2 LSB
{0x044E,0xFF},    // C0_GreenBlue_X2Y2
{0x044F,0x39},    // C0_GreenBlue_X2Y2 LSB

{0x0450,0x00},    // C0_Blue_X
{0x0451,0x75},    // C0_Blue_X LSB
{0x0452,0xFE},    // C0_Blue_Y
{0x0453,0x8C},    // C0_Blue_Y LSB
{0x0454,0x00},    // C0_Blue_X2
{0x0455,0x6D},    // C0_Blue_X2 LSB
{0x0456,0x00},    // C0_Blue_Y2
{0x0457,0x7E},    // C0_Blue_Y2 LSB
{0x0458,0x00},    // C0_Blue_XY
{0x0459,0x00},    // C0_Blue_XY LSB
{0x045A,0x00},    // C0_Blue_X2Y
{0x045B,0xD2},    // C0_Blue_X2Y LSB
{0x045C,0xFC},    // C0_Blue_XY2
{0x045D,0xD0},    // C0_Blue_XY2 LSB
{0x045E,0xFF},    // C0_Blue_X2Y2
{0x045F,0x7D},    // C0_Blue_X2Y2 LSB

{0x0460,0xFF},    // C1_GreenRed_X
{0x0461,0xCA},    // C1_GreenRed_X LSB
{0x0462,0xFE},    // C1_GreenRed_Y
{0x0463,0xA2},    // C1_GreenRed_Y LSB
{0x0464,0x00},    // C1_GreenRed_X2
{0x0465,0x80},    // C1_GreenRed_X2 LSB
{0x0466,0x00},    // C1_GreenRed_Y2
{0x0467,0x9A},    // C1_GreenRed_Y2 LSB
{0x0468,0x00},    // C1_GreenRed_XY
{0x0469,0xA0},    // C1_GreenRed_XY LSB
{0x046A,0x01},    // C1_GreenRed_X2Y
{0x046B,0x2E},    // C1_GreenRed_X2Y LSB
{0x046C,0x00},    // C1_GreenRed_XY2
{0x046D,0x9C},    // C1_GreenRed_XY2 LSB
{0x046E,0xFF},    // C1_GreenRed_X2Y2
{0x046F,0x36},    // C1_GreenRed_X2Y2 LSB

{0x0470,0xFF},    // C1_Red_X
{0x0471,0xDB},    // C1_Red_X LSB
{0x0472,0xFE},    // C1_Red_Y
{0x0473,0x3F},    // C1_Red_Y LSB
{0x0474,0x00},    // C1_Red_X2
{0x0475,0xB1},    // C1_Red_X2 LSB
{0x0476,0x00},    // C1_Red_Y2
{0x0477,0xD3},    // C1_Red_Y2 LSB
{0x0478,0x03},    // C1_Red_XY
{0x0479,0xA0},    // C1_Red_XY LSB
{0x047A,0x01},    // C1_Red_X2Y
{0x047B,0x21},    // C1_Red_X2Y LSB
{0x047C,0xFE},    // C1_Red_XY2
{0x047D,0x40},    // C1_Red_XY2 LSB
{0x047E,0xFE},    // C1_Red_X2Y2
{0x047F,0xDF},    // C1_Red_X2Y2 LSB

{0x0480,0xFF},    // C1_GreenBlue_X
{0x0481,0xCD},    // C1_GreenBlue_X LSB
{0x0482,0xFE},    // C1_GreenBlue_Y
{0x0483,0xA4},    // C1_GreenBlue_Y LSB
{0x0484,0x00},    // C1_GreenBlue_X2
{0x0485,0x80},    // C1_GreenBlue_X2 LSB
{0x0486,0x00},    // C1_GreenBlue_Y2
{0x0487,0x9A},    // C1_GreenBlue_Y2 LSB
{0x0488,0x03},    // C1_GreenBlue_XY
{0x0489,0xA0},    // C1_GreenBlue_XY LSB
{0x048A,0x01},    // C1_GreenBlue_X2Y
{0x048B,0x29},    // C1_GreenBlue_X2Y LSB
{0x048C,0x00},    // C1_GreenBlue_XY2
{0x048D,0x95},    // C1_GreenBlue_XY2 LSB
{0x048E,0xFF},    // C1_GreenBlue_X2Y2
{0x048F,0x36},    // C1_GreenBlue_X2Y2 LSB

{0x0490,0x00},    // C1_Blue_X
{0x0491,0x60},    // C1_Blue_X LSB
{0x0492,0xFE},    // C1_Blue_Y
{0x0493,0x9E},    // C1_Blue_Y LSB
{0x0494,0x00},    // C1_Blue_X2
{0x0495,0x6D},    // C1_Blue_X2 LSB
{0x0496,0x00},    // C1_Blue_Y2
{0x0497,0x82},    // C1_Blue_Y2 LSB
{0x0498,0x02},    // C1_Blue_XY
{0x0499,0xA0},    // C1_Blue_XY LSB
{0x049A,0x00},    // C1_Blue_X2Y
{0x049B,0xAA},    // C1_Blue_X2Y LSB
{0x049C,0xFE},    // C1_Blue_XY2
{0x049D,0x76},    // C1_Blue_XY2 LSB
{0x049E,0xFF},    // C1_Blue_X2Y2
{0x049F,0x53},    // C1_Blue_X2Y2 LSB

{0x04A0,0xFF},    // C2_GreenRed_X
{0x04A1,0x9F},    // C2_GreenRed_X LSB
{0x04A2,0xFE},    // C2_GreenRed_Y
{0x04A3,0x59},    // C2_GreenRed_Y LSB
{0x04A4,0x00},    // C2_GreenRed_X2
{0x04A5,0xBD},    // C2_GreenRed_X2 LSB
{0x04A6,0x00},    // C2_GreenRed_Y2
{0x04A7,0xD9},    // C2_GreenRed_Y2 LSB
{0x04A8,0x00},    // C2_GreenRed_XY
{0x04A9,0xDD},    // C2_GreenRed_XY LSB
{0x04AA,0x00},    // C2_GreenRed_X2Y
{0x04AB,0xEA},    // C2_GreenRed_X2Y LSB
{0x04AC,0x00},    // C2_GreenRed_XY2
{0x04AD,0x6B},    // C2_GreenRed_XY2 LSB
{0x04AE,0xFF},    // C2_GreenRed_X2Y2
{0x04AF,0x77},    // C2_GreenRed_X2Y2 LSB

{0x04B0,0xFF},    // C2_Red_X
{0x04B1,0xC7},    // C2_Red_X LSB
{0x04B2,0xFD},    // C2_Red_Y
{0x04B3,0x48},    // C2_Red_Y LSB
{0x04B4,0x01},    // C2_Red_X2
{0x04B5,0x37},    // C2_Red_X2 LSB
{0x04B6,0x01},    // C2_Red_Y2
{0x04B7,0x69},    // C2_Red_Y2 LSB
{0x04B8,0xFF},    // C2_Red_XY
{0x04B9,0x90},    // C2_Red_XY LSB
{0x04BA,0x01},    // C2_Red_X2Y
{0x04BB,0x84},    // C2_Red_X2Y LSB
{0x04BC,0xFD},    // C2_Red_XY2
{0x04BD,0x32},    // C2_Red_XY2 LSB
{0x04BE,0xFE},    // C2_Red_X2Y2
{0x04BF,0xE9},    // C2_Red_X2Y2 LSB

{0x04C0,0xFF},    // C2_GreenBlue_X
{0x04C1,0xA1},    // C2_GreenBlue_X LSB
{0x04C2,0xFE},    // C2_GreenBlue_Y
{0x04C3,0x5C},    // C2_GreenBlue_Y LSB
{0x04C4,0x00},    // C2_GreenBlue_X2
{0x04C5,0xBD},    // C2_GreenBlue_X2 LSB
{0x04C6,0x00},    // C2_GreenBlue_Y2
{0x04C7,0xD9},    // C2_GreenBlue_Y2 LSB
{0x04C8,0x00},    // C2_GreenBlue_XY
{0x04C9,0xD9},    // C2_GreenBlue_XY LSB
{0x04CA,0x00},    // C2_GreenBlue_X2Y
{0x04CB,0xE8},    // C2_GreenBlue_X2Y LSB
{0x04CC,0x00},    // C2_GreenBlue_XY2
{0x04CD,0x6B},    // C2_GreenBlue_XY2 LSB
{0x04CE,0xFF},    // C2_GreenBlue_X2Y2
{0x04CF,0x75},    // C2_GreenBlue_X2Y2 LSB

{0x04D0,0x00},    // C2_Blue_X
{0x04D1,0x47},    // C2_Blue_X LSB
{0x04D2,0xFE},    // C2_Blue_Y
{0x04D3,0x4A},    // C2_Blue_Y LSB
{0x04D4,0x00},    // C2_Blue_X2
{0x04D5,0xA7},    // C2_Blue_X2 LSB
{0x04D6,0x00},    // C2_Blue_Y2
{0x04D7,0xC1},    // C2_Blue_Y2 LSB
{0x04D8,0xFF},    // C2_Blue_XY
{0x04D9,0x5B},    // C2_Blue_XY LSB
{0x04DA,0x00},    // C2_Blue_X2Y
{0x04DB,0x6F},    // C2_Blue_X2Y LSB
{0x04DC,0xFE},    // C2_Blue_XY2
{0x04DD,0xE7},    // C2_Blue_XY2 LSB
{0x04DE,0xFF},    // C2_Blue_X2Y2
{0x04DF,0x7B},    // C2_Blue_X2Y2 LSB

{0x04E0,0xFF},    // C3_GreenRed_X
{0x04E1,0xE2},    // C3_GreenRed_X LSB
{0x04E2,0xFE},    // C3_GreenRed_Y
{0x04E3,0xBB},    // C3_GreenRed_Y LSB
{0x04E4,0x00},    // C3_GreenRed_X2
{0x04E5,0x70},    // C3_GreenRed_X2 LSB
{0x04E6,0x00},    // C3_GreenRed_Y2
{0x04E7,0x90},    // C3_GreenRed_Y2 LSB
{0x04E8,0xFD},    // C3_GreenRed_XY
{0x04E9,0x00},    // C3_GreenRed_XY LSB
{0x04EA,0x01},    // C3_GreenRed_X2Y
{0x04EB,0x11},    // C3_GreenRed_X2Y LSB
{0x04EC,0x00},    // C3_GreenRed_XY2
{0x04ED,0x37},    // C3_GreenRed_XY2 LSB
{0x04EE,0xFF},    // C3_GreenRed_X2Y2
{0x04EF,0x49},    // C3_GreenRed_X2Y2 LSB

{0x04F0,0xFF},    // C3_Red_X
{0x04F1,0xFB},    // C3_Red_X LSB
{0x04F2,0xFE},    // C3_Red_Y
{0x04F3,0x2E},    // C3_Red_Y LSB
{0x04F4,0x00},    // C3_Red_X2
{0x04F5,0xA1},    // C3_Red_X2 LSB
{0x04F6,0x00},    // C3_Red_Y2
{0x04F7,0xDA},    // C3_Red_Y2 LSB
{0x04F8,0xFF},    // C3_Red_XY
{0x04F9,0xBB},    // C3_Red_XY LSB
{0x04FA,0x02},    // C3_Red_X2Y
{0x04FB,0x22},    // C3_Red_X2Y LSB
{0x04FC,0xFE},    // C3_Red_XY2
{0x04FD,0x92},    // C3_Red_XY2 LSB
{0x04FE,0xFE},    // C3_Red_X2Y2
{0x04FF,0x85},    // C3_Red_X2Y2 LSB

{0x0500,0xFF},    // C3_GreenBlue_X
{0x0501,0xE3},    // C3_GreenBlue_X LSB
{0x0502,0xFE},    // C3_GreenBlue_Y
{0x0503,0xBD},    // C3_GreenBlue_Y LSB
{0x0504,0x00},    // C3_GreenBlue_X2
{0x0505,0x70},    // C3_GreenBlue_X2 LSB
{0x0506,0x00},    // C3_GreenBlue_Y2
{0x0507,0x90},    // C3_GreenBlue_Y2 LSB
{0x0508,0x00},    // C3_GreenBlue_XY
{0x0509,0x96},    // C3_GreenBlue_XY LSB
{0x050A,0x01},    // C3_GreenBlue_X2Y
{0x050B,0x11},    // C3_GreenBlue_X2Y LSB
{0x050C,0x00},    // C3_GreenBlue_XY2
{0x050D,0x31},    // C3_GreenBlue_XY2 LSB
{0x050E,0xFF},    // C3_GreenBlue_X2Y2
{0x050F,0x48},    // C3_GreenBlue_X2Y2 LSB

{0x0510,0x00},    // C3_Blue_X
{0x0511,0x5C},    // C3_Blue_X LSB
{0x0512,0xFE},    // C3_Blue_Y
{0x0513,0xBA},    // C3_Blue_Y LSB
{0x0514,0x00},    // C3_Blue_X2
{0x0515,0x63},    // C3_Blue_X2 LSB
{0x0516,0x00},    // C3_Blue_Y2
{0x0517,0x7E},    // C3_Blue_Y2 LSB
{0x0518,0xFF},    // C3_Blue_XY
{0x0519,0x86},    // C3_Blue_XY LSB
{0x051A,0x00},    // C3_Blue_X2Y
{0x051B,0xBB},    // C3_Blue_X2Y LSB
{0x051C,0xFF},    // C3_Blue_XY2
{0x051D,0x65},    // C3_Blue_XY2 LSB
{0x051E,0xFF},    // C3_Blue_X2Y2
{0x051F,0x4F},    // C3_Blue_X2Y2 LSB

{0x0561,0x00},    // C0 Unity
{0x0562,0x00},    // C1 Unity
{0x0563,0x01},    // C2 Unity
{0x0564,0x00},    // C3 Unity
...
{0x041A,0xBC}, //	; GInB
{0x041B,0x5E}, //	;
{0x01A5,0x3E}, //	; Hue Red Bias
{0x01A6,0x00}, //
{0x01A7,0x3E}, //	; Hue Blue Bias
{0x01A8,0x00}, //
...
{0x0571,0x00}, //	; = 4.00
{0x0572,0x41}, //	; fpBlueTilt
{0x0573,0xc0}, //	; = 4.00
{0x0081,0x5c}, //	; PipeSetupCommon bColourSaturation
...
{0x0082,0x68}, //	; PipeSetupCommon bBrightness
