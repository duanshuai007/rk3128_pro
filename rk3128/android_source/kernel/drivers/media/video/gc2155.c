...
#define ADB_DEBUG   0 //For adb debug 

#if ADB_DEBUG
#include <linux/proc_fs.h>
static struct i2c_client *gc2155_client;
#endif
...
static ssize_t gc2155_proc_write(struct file *filp, const char __user *buffer, \
...
static const struct file_operations gc2155_proc_fops = {
	.owner		= THIS_MODULE, 
	.write		= gc2155_proc_write,
}; 
...
{
#if ADB_DEBUG
	gc2155_client = client;

	proc_entry = proc_create("driver/camsensor", 0666, NULL,&gc2155_proc_fops);
	if (proc_entry == NULL) {
